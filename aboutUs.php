  ...
  <header>
    <div class="container">
      ...
      <div class="header-signIn">
        <a class="header-signIn-a" href="singIn.php">Sign In</a>
      </div>
    </div>
  </header>
  ...
  <div class="showcase">
    <div class="container">
      <div class="showcase-infos-bg">
          <p class="showcase-infos-p">The aim of ARU Hosweb is to make it easy for patients to ask their questions to doctors and to avoid paying fees for a few questions.</p>
          <h3 class="showcase-infos-h3">ARU Hosweb is a bridge between doctors and patients.</h4>
          <h4 class="showcase-infos-h4">Doctors:</h3>
          <li class="showcase-infos-li">Prof. Dr. Mustafa Berat Aru</li>
          <li class="showcase-infos-li">Prof. Dr. Nur Erdogan</li>
          <li class="showcase-infos-li">Prof. Dr. Wollion Sherk</li>
          <li class="showcase-infos-li">Dr. Kitea Miniqu</li>
          <li class="showcase-infos-li">Asst Dr. Nida Duman</li>
      </div>
    </div>
  </div>
