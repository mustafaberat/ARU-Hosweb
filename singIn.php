  ...
  <header>
    <div class="container">
      ...
      <div class="header-signUp">
        <a class="header-signUp-a" href="singUp.php">Sign Up</a>
      </div>
    </div>
  </header>
    ...
    <div class="showcase">
      <div class="container">
        <div class="showcase-infos-bg">
          ...
          <div class="showcase-signIn-email">
            <div class="showcase-signIn-email-writing">E-mail
              <input class="showcase-signIn-email-input" name="signIn-email" type="email" id="showcase-signIn-email-id" required>
            </div>
          </div>

     

          <div class="showcase-signIn-password">
            <div class="showcase-signIn-password-writing">Password
              <input class="showcase-signIn-password-input" name="signIn-password" type="password" id="showcase-signIn-password-id" required>
            </div>
          </div>

          <div class="showcase-button showcase-button-signIn">
            <button class="showcase-button-a" type="submit"name="signIn-button">Sign Up</button>
          </div>

        </div>

      <div class="forgotPassword">
        <a href="forgotPassword.php" class="forgotPassword-a">Forgot Password?</a>
      </div>
		</div>
    </div>
  </form>
...
mysqli_select_db($link,'aruhosweb_database');
 ...
 if ($num == 1) {
  	// header('Location: askDoctor.php');
    // header('Location: http://localhost/ARUHosweb/askDoctor.php');
    echo "<script type= 'text/javascript'>alert('Login successfully'); </script>";
    include 'askDoctor.php';
	}
}
