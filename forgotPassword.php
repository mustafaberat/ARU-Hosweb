  ...
  <div class="showcase">
    <div class="container">
      <div class="showcase-infos-bg">
        ...
        <div class="showcase-forgot-email">
          <div class="showcase-forgot-explaining">
            <h4>Enter your email address. <br> We will send you a link to reset your password.</h4>
          </div>
          <div class="showcase-forgot-email-writing">E-mail
            <input class="showcase-forgot-email-input" name="forgotPassword-input" type="email" required>
          </div>
        </div>

        <div class="showcase-button showcase-button-forgotPassword">
            <button class="showcase-button-a" type="submit" name="forgotPassword-button">Reset Email</button>
        </div>
      </div>
...
mysqli_select_db($link,'aruhosweb_database');
  ...
  if (isset($_POST["forgotPassword-button"])) {
  
    $email = $_POST['forgotPassword-input'];
   
  $res = mysqli_query($link, "SELECT * FROM user where Email ='$email' ");
  $num = mysqli_num_rows($res);

 if ($num == 1) {
  echo "<script type= 'text/javascript'>alert('Your password sent your mail'); </script>";
  // header("location: singIn.php");
}
else{
  echo "<script type= 'text/javascript'>alert('We dont have your email'); </script>";
